...
ALLOWED_HOSTS = ['teamlemming.pythonanywhere.com',"127.0.0.1", "localhost"]
...
MIDDLEWARE = [
    ...
    'tasks.middleware.TaskNotificationMiddleware',
]
...
STATIC_ROOT = '/home/teamlemming/Lemming/staticfiles'
